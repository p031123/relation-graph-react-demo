...
const staticJsonData = {
  nodes: [
    ...
    { id: "1", color: "#00CDBA", data: { event: false }, text: "初音未來" },
    ...
    { id: "22", color: "#FF9900", data: { event: true }, text: "神代類" },
